...
public class CreateFolder {
	...
	/**
	 * Método que crea el folder principal del proyecto
	 * 
	 * @param name
	 *            , nombre del proyecto
	 */
	public void createFolderProject(String name) {
		createFolder(path + "/" + name);
	}

	/**
	 * Método que crea las carpetas necesarias para una pagina web
	 * 
	 * @param nameProject
	 */
	public void createFolderWebPage(String nameProject) {
		String pathLocal = nameProject + "/" + nameProject + "-"
				+ Constant.webPage.toString();
	...
	public void createFolderPrincipalJSF(String name)
		...
		try {
			...
			StringWriter writer = this.util.executeTemplate("pomPpal.vm", map,
					"templates");
			salidatxt = new PrintStream(path + "/" + name + "/" + name
					+ "/pom.xml");
	...
	private void createFolderInternal(String nameModule, String nameProject) {
		String pathLocal = nameProject + "/" + nameProject + "/" + nameProject
				+ "-" + nameModule;
